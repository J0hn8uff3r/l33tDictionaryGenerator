    ...
    if len(dictWord) > 0:
        ...
        if dictionary_type == "simple":
            if currentLetter in simple:
                ...
                # print(substitutions)
        elif dictionary_type == "medium":
            if currentLetter in medium:
                substitutions = medium[currentLetter] + [currentLetter]
                # print(substitutions)
            else:
                substitutions = [currentLetter]
                # print(substitutions)
...
parser.add_argument('dictionary_type', help='simple, medium, or complex')
